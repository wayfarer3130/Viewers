window.config = {
  ...
  servers: {
    dicomWeb: [
      {
        name: 'DICOMCLOUD',
        wadoUriRoot: 'https://ks.vetmed.fu-berlin.de/WadoWebApi/api/wadouri',
        qidoRoot: 'https://ks.vetmed.fu-berlin.de/WadoWebApi/api',
        wadoRoot: 'https://ks.vetmed.fu-berlin.de/WadoWebApi/api',
