  ...
  setMeasurements() {
    ...
    switch (type) {
      case 'ELLIPSE':
        ...
        const areaEllipse = Math.PI * radius * radius * 1000;
        this._area = areaEllipse.toFixed(2);
        this._length = undefined;
        break;

      case 'POLYGON':
        const areaPolygon = areaOfPolygon(coordinates) * 1000;
        this._area = areaPolygon.toFixed(2);
        this._length = undefined;
        break;
      ...
      case 'POLYLINE':
        ...
        const len = Math.sqrt(xLen + yLen) * 1000;
        this._area = undefined;
        this._length = len.toFixed(2);
        break;
    }
  }
